[![GoDoc reference](https://img.shields.io/badge/godoc-reference-blue.svg)](https://pkg.go.dev/github.com/btwiuse/jsonl)
...
See [documentation](https://pkg.go.dev/github.com/btwiuse/jsonl) for more details.
